...
The published URL will typically be:

```text
https://<your-github-username>.github.io/<repo-name>/
```

## Why This Submission Fits The Assignment

- It uses a **scripted language**: Bash
- It includes **simple graphics** in the terminal
- It clearly identifies **recursion** and **iteration** in the code comments
- It optionally supports a **public GitHub-hosted presentation**

## LaTeX Report

A matching LaTeX version of the write-up is included in:

- `report.tex`

If you want a PDF, you can compile it locally with:
